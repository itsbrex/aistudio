...
export const VIDEO_ASPECT_RATIOS = [
  { id: "16:9", label: "Landscape (16:9)", description: "Best for YouTube, websites" },
  { id: "9:16", label: "Portrait (9:16)", description: "Best for Instagram Reels, TikTok" },
  { id: "1:1", label: "Square (1:1)", description: "Best for Instagram, Facebook" },
] as const
