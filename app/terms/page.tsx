  ...
  return (
    ...
    >
      <LegalSection title="1. Acceptance of Terms">
        <p>
          By accessing or using AI Studio (&quot;the Service&quot;), you agree to be bound by
      ...
      <LegalSection title="2. Description of Service">
        <p>
          AI Studio provides AI-powered photo enhancement and video creation services
          for real estate professionals. Our service allows you to upload property
          images, apply AI enhancements, and generate professional marketing
          materials.
        </p>
      </LegalSection>
      ...
      <LegalSection title="4. Payment and Pricing">
        <p>
          AI Studio operates on a pay-per-use model. Current pricing is as follows:
        </p>
        <ul className="ml-4 list-disc space-y-2">
          <li>
            <strong>Photo Enhancement:</strong> 1000&nbsp;NOK per property (up to 20
            images)
          </li>
          <li>
        ...
        <p>
          ...
          processed securely through our payment provider. Payments are non-refundable
      ...
      <LegalSection title="5. Refund Policy">
        <p>
          If you are not satisfied with the results of our AI processing, you may
          request a refund within 24 hours of the processing completion. Refund
          requests should be submitted to{" "}
          <a href="mailto:support@aistudio.no" className="underline">
            support@aistudio.no
          </a>{" "}
          with your order details and reason for dissatisfaction.
        </p>
        <p>
          We reserve the right to deny refund requests that we determine, in our sole
          discretion, to be fraudulent or abusive.
        </p>
      </LegalSection>

      <LegalSection title="6. User Content">
        <p>You retain ownership of all images and content you upload to the Service.</p>
        ...
        <p>
          You represent and warrant that you have all necessary rights to upload and
          use the content, and that your content does not violate any third-party
          rights.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Intellectual Property">
        <p>
          ...
          is owned by AI Studio and is protected by international copyright,
          trademark, and other intellectual property laws.
        </p>
        <p>
          Enhanced images produced by our Service are owned by you, subject to any
          underlying rights in the original images.
        </p>
      </LegalSection>
      ...
      <LegalSection title="9. Limitation of Liability">
        <p>
          To the maximum extent permitted by law, AI Studio shall not be liable for
          any indirect, incidental, special, consequential, or punitive damages,
          including loss of profits, data, or other intangible losses, resulting from:
        </p>
        <ul className="ml-4 list-disc space-y-2">
      ...
      <LegalSection title="12. Governing Law">
        <p>
          ...
          of Norway, without regard to its conflict of law provisions. Any disputes
          arising from these Terms shall be resolved in the courts of Norway.
        </p>
      </LegalSection>
      ...
      <LegalSection title="14. Contact Us">
        ...
        <p className="mt-2">
          ...
          <br />
          Email:{" "}
          <a href="mailto:legal@aistudio.no" className="underline">
            legal@aistudio.no
          </a>
          <br />
          General inquiries:{" "}
          <a href="mailto:hello@aistudio.no" className="underline">
            hello@aistudio.no
          </a>
        </p>
      </LegalSection>
